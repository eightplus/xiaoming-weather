    ...
    : QListView(parent)
{
    ...
    this->setStyleSheet("QListView{border:none;margin:0px;padding:0px;outline:none;background-color:rgba(255, 255, 255, 1);}QListView::item:selected:!active{background:#e9eef1;}QListView::item:selected:active{background:#3f96e4;}QListView::item:hover{background:#e9eef0;}");//QListView::item{height:36px;} QListView::item:selected{color:white;background-color:#e9eef0;}
